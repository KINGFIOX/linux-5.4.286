...
extern const char *__get_key_name(const struct lockdep_subclass_key *key, char *str);
...
static inline unsigned long lockdep_count_backward_deps(struct lock_class *class)
{
	return 0;
}
#endif
...
#define debug_class_ops_inc(ptr)                                                                                                                               \
	do {                                                                                                                                                   \
	} while (0)
#endif
