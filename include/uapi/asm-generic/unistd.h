...
__SC_COMP(__NR_process_vm_readv, sys_process_vm_readv, compat_sys_process_vm_readv)
#define __NR_process_vm_writev 271
__SC_COMP(__NR_process_vm_writev, sys_process_vm_writev, compat_sys_process_vm_writev)
