...
extern void kmemleak_alloc(const void *ptr, size_t size, int min_count, gfp_t gfp) __ref;
extern void kmemleak_alloc_percpu(const void __percpu *ptr, size_t size, gfp_t gfp) __ref;
extern void kmemleak_vmalloc(const struct vm_struct *area, size_t size, gfp_t gfp) __ref;
...
extern void kmemleak_alloc_phys(phys_addr_t phys, size_t size, int min_count, gfp_t gfp) __ref;
...
static inline void kmemleak_alloc_percpu(const void __percpu *ptr, size_t size, gfp_t gfp)
{
}
