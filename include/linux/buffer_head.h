...
static inline void sb_breadahead_unmovable(struct super_block *sb, sector_t block)
{
...
static inline struct buffer_head *sb_find_get_block(struct super_block *sb, sector_t block)
{
...
static inline struct buffer_head *getblk_unmovable(struct block_device *bdev, sector_t block, unsigned size)
{
