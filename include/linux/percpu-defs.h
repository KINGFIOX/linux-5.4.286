...
#define DECLARE_PER_CPU_DECRYPTED(type, name) DECLARE_PER_CPU_SECTION(type, name, "..decrypted")

#define DEFINE_PER_CPU_DECRYPTED(type, name) DEFINE_PER_CPU_SECTION(type, name, "..decrypted")
#else
...
#define __pcpu_size_call_return(stem, variable)                                                                                                                \
	({                                                                                                                                                     \
		...
		case 1:                                                                                                                                        \
			pscr_ret__ = stem##1(variable);                                                                                                        \
			break;                                                                                                                                 \
		case 2:                                                                                                                                        \
			pscr_ret__ = stem##2(variable);                                                                                                        \
			break;                                                                                                                                 \
		case 4:                                                                                                                                        \
			pscr_ret__ = stem##4(variable);                                                                                                        \
			break;                                                                                                                                 \
		case 8:                                                                                                                                        \
			pscr_ret__ = stem##8(variable);                                                                                                        \
			break;                                                                                                                                 \
		default:                                                                                                                                       \
...
#define __pcpu_size_call_return2(stem, variable, ...)                                                                                                          \
	({                                                                                                                                                     \
		...
		switch (sizeof(variable)) {                                                                                                                    \
		case 1:                                                                                                                                        \
			pscr2_ret__ = stem##1(variable, __VA_ARGS__);                                                                                          \
			break;                                                                                                                                 \
		case 2:                                                                                                                                        \
			pscr2_ret__ = stem##2(variable, __VA_ARGS__);                                                                                          \
			break;                                                                                                                                 \
		case 4:                                                                                                                                        \
			pscr2_ret__ = stem##4(variable, __VA_ARGS__);                                                                                          \
			break;                                                                                                                                 \
		case 8:                                                                                                                                        \
			pscr2_ret__ = stem##8(variable, __VA_ARGS__);                                                                                          \
			break;                                                                                                                                 \
		default:                                                                                                                                       \
			__bad_size_call_parameter();                                                                                                           \
			break;                                                                                                                                 \
...
#define __pcpu_double_call_return_bool(stem, pcp1, pcp2, ...)                                                                                                  \
	({                                                                                                                                                     \
		...
		switch (sizeof(pcp1)) {                                                                                                                        \
		case 1:                                                                                                                                        \
			pdcrb_ret__ = stem##1(pcp1, pcp2, __VA_ARGS__);                                                                                        \
			break;                                                                                                                                 \
		case 2:                                                                                                                                        \
			pdcrb_ret__ = stem##2(pcp1, pcp2, __VA_ARGS__);                                                                                        \
			break;                                                                                                                                 \
		case 4:                                                                                                                                        \
			pdcrb_ret__ = stem##4(pcp1, pcp2, __VA_ARGS__);                                                                                        \
			break;                                                                                                                                 \
		case 8:                                                                                                                                        \
			pdcrb_ret__ = stem##8(pcp1, pcp2, __VA_ARGS__);                                                                                        \
			break;                                                                                                                                 \
		default:                                                                                                                                       \
			__bad_size_call_parameter();                                                                                                           \
			break;                                                                                                                                 \
...
// stem, such as : raw_cpu_add_
#define __pcpu_size_call(stem, variable, ...)                                                                                                                  \
	do {                                                                                                                                                   \
		__verify_pcpu_ptr(&(variable));                                                                                                                \
		switch (sizeof(variable)) {                                                                                                                    \
		case 1:                                                                                                                                        \
			stem##1(variable /*such as *sem->read_count*/, __VA_ARGS__ /*such as 1*/);                                                             \
			break;                                                                                                                                 \
		case 2:                                                                                                                                        \
			stem##2(variable, __VA_ARGS__);                                                                                                        \
			break;                                                                                                                                 \
		case 4:                                                                                                                                        \
			stem##4(variable, __VA_ARGS__);                                                                                                        \
			break;                                                                                                                                 \
		case 8:                                                                                                                                        \
			stem##8(variable, __VA_ARGS__);                                                                                                        \
			break;                                                                                                                                 \
		default:                                                                                                                                       \
			__bad_size_call_parameter();                                                                                                           \
			break;                                                                                                                                 \
...
#define raw_cpu_add(pcp, val) __pcpu_size_call(raw_cpu_add_, pcp /*such as *sem->read_count*/, val /*such as 1*/)
...
#define __this_cpu_add(pcp, val)                                                                                                                               \
	({                                                                                                                                                     \
		__this_cpu_preempt_check("add"); /*lint, kbuild*/                                                                                              \
		raw_cpu_add(pcp /*such as *sem->read_count*/, val /*such as 1*/);                                                                              \
	})
...
#define __this_cpu_inc(pcp) __this_cpu_add(pcp /*such as *sem->read_count*/, 1)
