...
#define KMEM_CACHE_USERCOPY(__struct, __flags, __field)                                                                                                        \
	kmem_cache_create_usercopy(#__struct, sizeof(struct __struct), __alignof__(struct __struct), (__flags), offsetof(struct __struct, __field),            \
...
#ifdef CONFIG_NUMA
extern void *kmem_cache_alloc_node_trace(struct kmem_cache *s, gfp_t gfpflags, int node, size_t size) __assume_slab_alignment __malloc;
#else
