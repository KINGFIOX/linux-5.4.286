...
#define VM_FAULT_RESULT_TRACE                                                                                                                                  \
	{ VM_FAULT_OOM, "OOM" }, { VM_FAULT_SIGBUS, "SIGBUS" }, { VM_FAULT_MAJOR, "MAJOR" }, { VM_FAULT_WRITE, "WRITE" }, { VM_FAULT_HWPOISON, "HWPOISON" },   \
		{ VM_FAULT_HWPOISON_LARGE, "HWPOISON_LARGE" }, { VM_FAULT_SIGSEGV, "SIGSEGV" }, { VM_FAULT_NOPAGE, "NOPAGE" }, { VM_FAULT_LOCKED, "LOCKED" },  \
