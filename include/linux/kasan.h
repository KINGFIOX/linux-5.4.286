...
int kasan_populate_early_shadow(const void *shadow_start, const void *shadow_end);
...
void *__must_check kasan_kmalloc(struct kmem_cache *s, const void *object, size_t size, gfp_t flags);
void *__must_check kasan_krealloc(const void *object, size_t new_size, gfp_t flags);

void *__must_check kasan_slab_alloc(struct kmem_cache *s, void *object, gfp_t flags);
...
static inline void kasan_cache_create(struct kmem_cache *cache, unsigned int *size, slab_flags_t *flags)
{
}
