...
#define list_for_each_entry_safe(pos, next, head, member)                                                                                                      \
	for (pos = list_first_entry(head, typeof(*pos), member), next = list_next_entry(pos, member); /**/                                                     \
 ...
 */
#define list_for_each_entry_safe_continue(pos, next, head, member)                                                                                             \
	for (pos = list_next_entry(pos, member), next = list_next_entry(pos, member); /**/                                                                     \
	     !list_entry_is_head(pos, head, member); /**/                                                                                                      \
	     pos = next, next = list_next_entry(next, member)) /**/
...
#define list_for_each_entry_safe_reverse(pos, n, head, member)                                                                                                 \
	for (pos = list_last_entry(head, typeof(*pos), member), n = list_prev_entry(pos, member); !list_entry_is_head(pos, head, member);                      \
